...
namespace web.Controllers
{
    ...
    {
        private TVDbContext db = new TVDbContext();
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Description")] TVSeries tVSeries)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Description")] TVSeries tVSeries)
        {
            if (ModelState.IsValid)
            {
